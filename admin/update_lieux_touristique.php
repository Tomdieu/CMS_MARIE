...
if (isset($_GET['id'])) {
    ...
    $lieu_data = $lieu->findById($lieux_id);
} else {
    ...
    <div class="home_content">
        ...
        <main style="display:block;justify-content:center;align-items:center">
            ...
            <div class="add_personnel">
                ...
                <div id="status"></div>
                <input type="hidden" id="lieux_id" value="<?php echo $lieux_id ?>" />
                <input type="hidden" id="id_marie" value="<?php echo $id_marie; ?>" />
                <div class="input">
                    <label>Nom du lieu</label>
                    <input type="text" id="nom" value="<?php echo $lieu_data['nom'] ?>" />
                </div>
                ...
                <div class="input">
                    ...
                    <div id="content" class="editor" contenteditable="true" spellcheck="false"><?php echo $lieu_data['description'] ?></div>
                </div>
                <div class="input">
                    <label>Image Du lieux touristique</label>
        ...
        <script>
            ...
            var id = document.querySelector('#lieux_id');
            ...
            submit.addEventListener('click', () => {
                ...
                xml.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        if (data['updated'] == true) {
                            ...
                            status_.innerHTML = 'LieuxTouristique Updated Successfully';
                ...
                var url;
                url = 'includes/ajax/update_touristique_site.php';
