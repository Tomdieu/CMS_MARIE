...
if (!isset($_SESSION['id'])) {
    ...
    if(isset($_GET['id'])){
        ...
        $hist = new Histoire();
        $hist_data = $hist->findById($_GET['id']);
    ...
    <div class="home_content">
        ...
        <main style="display:block;justify-content:center;align-items:center">
            <div class="add_personnel">
                ...
                <input type="hidden" id="id_history" value="<?php echo $id_history; ?>">
                <div class="input ">
                ...
                <div class="form-input">
                    ...
                    <div class="editor" id="histiore" contenteditable="true" spellcheck="false"><?php echo($hist_data[0]['content'])?></div>
                </div>
            ...
            <script>
                var id_history = document.querySelector('#id_history');
                ...
                submitBtn.addEventListener('click',()=>{
                    ...
                    let url = 'includes/ajax/update_history.php';
                    var formData = new FormData();
                    formData.append('content',histiore.innerHTML);
                    formData.append('id',id_history.value);
                    ...
                    xml.onreadystatechange = function (){
                        if(this.readyState == 4 && this.status == 200){
                            ...
                            if(data['updated'] == true){
                                ...
                                function redirect(){
                                    document.location = 'histoire.php';
                                }
                            }else{
