    ...
    <div class="home_content">
        ...
        <main style="display:block;justify-content:center;align-items:center">
            ...
            <div class="add_personnel">
                ...
                <div class="input">
                    <label for="content">Contenue de la publiciter </label>
        ...
        <script>
            ...
            submit.addEventListener('click', () => {
                ...
                xml.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        if (data['created'] == true) {
                            ...
                            status_.innerHTML = 'Publiciter Save Successfully';
                ...
                var url;
                url = 'includes/ajax/create_publiciter.php';
