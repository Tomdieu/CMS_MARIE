    ...
    <div class="home_content">
        ...
        <main style="display:block;justify-content:center;align-items:center">
            ...
            <div class="add_personnel">
                ...
                <div class="input">
                    <label>Auteur De L'annonce</label>
                ...
                <div class="input">
                    ...
                    <select id="type_annonce">
                        ...
                        <option value="actes">Actes(Decrets) De La Marie</option>
                        <option value="marches">Marches Public</option>
                ...
                <div class="input">
                    <label for="content"> Replisser Le Detail de l'annonce</label>
                    <div id="content" class="editor" contenteditable="true" spellcheck="false"></div>
                </div>
                <div class="input">
                    <label>Image De L'annnce (optionnel)</label>
        ...
        <script>
            ...
            var type_annonce = document.querySelector('#type_annonce');
            ...
            submit.addEventListener('click', () => {
                console.log(type_annonce.value);
                if (nom.value.length == 0) {
                    alert('Please Enter The Name of the project')
                    return;
                }

                if (type_annonce.value.length === 0) {
                    alert('Please Select A Type of annonce!');
                    return;
                }
                ...
                formData.append('type_annonce', type_annonce.value);
                if (image.files.length !== 0) {
                ...
                xml.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        if (data['created'] == true) {
                            ...
                            status_.innerHTML = 'Projet Save Successfully';
                ...
                var url;
                url = 'includes/ajax/create_annonce.php';
