    ...
    <div class="home_content">
        ...
        <script>
            ...
            submitBtn.addEventListener('click',(e)=>{
                ...
                console.log({content,id_mission});
                ...
                xml.onreadystatechange = function (){
                    if(this.readyState == 4 && this.status == 200){
                        ...
                        if(data['updated'] == true){
                            ...
                            _alert.innerHTML = "<h1 style='background-color:rgb(40, 255, 122);color:#fff;font-weigth:900;padding:10px'>Mission Updated Successfully!</h1>";
                            ...
                            _alert.innerHTML = "<h1 style='background-color:rgb(223, 25, 25);color:#fff;font-weigth:900;padding:10px'>Mission Coulld Not Be Updated!</h1>";

                        }
                    }
                }
                let url = 'includes/ajax/update_mission.php';
                xml.open('POST',url,true);
                xml.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                xml.send('id='+parseInt(id_mission)+'&content='+content);
